# TiDB Cloud Lake Python UDF

Write user-defined functions in Python for TiDB Cloud Lake.
...
### TiDB Cloud Lake Config

Edit the TiDB Cloud Lake query service config:
